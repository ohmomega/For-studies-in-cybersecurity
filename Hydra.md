...
Hydra สามารถรันผ่าน list และ "brute force" บริการตรวจสอบสิทธิ์บางอย่างได้ ลองนึกภาพการลองเดารหัสผ่านของใครบางคนด้วยตนเองในบริการเฉพาะ (SSH, Web Application Form, FTP หรือ SNMP) เราสามารถใช้ Hydra รันผ่านรายการรหัสผ่านและเร่งกระบวนการนี้ให้เรา เพื่อค้นหารหัสผ่านที่ถูกต้อง
